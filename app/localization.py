...
LOGIN_PAGE = {
    ...
    "password_validation_error": {"EN": "Passwords must have at least 8 characters and contain at least two of the following: uppercase letters, lowercase letters, numbers, and symbols", "UA": "Пароль повинен містити принаймні 8 символів та складатися з принаймні двох з наступних: великих літер, малих літер, цифр та символів."},
    "email_validation_error": {"EN": "Wrong format of email. Check it again.", "UA": "Неправильний формат пошти. Перевірте будь ласка ще раз."},
    "message_wrong_email_or_pass": {"EN": "Wrong email or password!", "UA": "Неправильна пошта або пароль!"},
    "registration_title": {"EN": "Registration", "UA": "Реєстрація"},
    "email_already_taken_message": {"EN": "Email is already taken. Please use another or try to restore password.", "UA": "Така пошта вже зайнята. Будь ласка, використайте іншу або спробуйте відновити пароль."},
    "email_already_taken_message_title": {"EN": "Email already taken", "UA": "Пошта вже зайнята"},
    "code_sent_message": {"EN": "Your code sent to your malibox. It lasts only 10 minutes.", "UA": "Ваш код надіслано на вашу пошту. Він діє лише 10 хвилин."},
    ...
    "email_doesnt_exist_msg": {"EN": "Email doesn't exist. Please try again.", "UA": "Пошта не існує. Будь ласка, спробуйте ще раз."},
...
MAIN_WINDOW = {
    ...
    "image_processing_settings_label": {"EN": "Image Processing Settings", "UA": "Налаштування обробки зображень"},
...
MESSAGES = {
    "unhandled_exception" : {"EN": "Whoops. Unhandled exception happened. Do you want to send logs to devs to provide info about it?", "UA": "Ой. Непередбачувана помилка. Ви хочете надіслати логи, щоб надати інформацію розробникам?"},
